...
describe('DetectionsToRects', function () {
    it('detection to rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithLocationData(100, 200, 300, 400), 'boundingbox', 'rect');
    ...
    it('detection keypoints to rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var rects;
        return __generator(this, function (_a) {
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0, 0], [1, 1]]), 'keypoints', 'rect', { width: 640, height: 480 });
            expectRectEq(rects, 320, 240, 640, 480);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0.25, 0.25], [0.75, 0.75]]), 'keypoints', 'rect', { width: 640, height: 480 });
            expectRectEq(rects, 320, 240, 320, 240);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0, 0], [0.5, 0.5]]), 'keypoints', 'rect', { width: 640, height: 480 });
            expectRectEq(rects, 160, 120, 320, 240);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0.5, 0.5], [1, 1]]), 'keypoints', 'rect', { width: 640, height: 480 });
            expectRectEq(rects, 480, 360, 320, 240);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0.25, 0.25], [0.75, 0.75]]), 'keypoints', 'rect', { width: 0, height: 0 });
    ...
    it('detection to normalized rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var rects;
        return __generator(this, function (_a) {
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithRelativeLocationData(0.1, 0.2, 0.3, 0.4), 'boundingbox', 'normRect');
    ...
    it('detection keypoints to normalized rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var rects;
        return __generator(this, function (_a) {
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0, 0], [0.5, 0.5], [1, 1]]), 'keypoints', 'normRect');
            expectRectEq(rects, 0.5, 0.5, 1, 1);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0.25, 0.25], [0.75, 0.25], [0.75, 0.75]]), 'keypoints', 'normRect');
            expectRectEq(rects, 0.5, 0.5, 0.5, 0.5);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0, 0], [0.5, 0.5]]), 'keypoints', 'normRect');
            expectRectEq(rects, 0.25, 0.25, 0.5, 0.5);
            rects = detection_to_rect_1.calculateDetectionsToRects(detectionWithKeyPoints([[0.5, 0.5], [1, 1]]), 'keypoints', 'normRect');
