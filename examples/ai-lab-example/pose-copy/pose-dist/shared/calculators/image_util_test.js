...
describe('GetRoi', function () {
    it('no norm rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expectRotatedRectEq(image_utils_1.getRoi({ width: 4, height: 4 }), 4, 4, 2, 2, 0);
            expectRotatedRectEq(image_utils_1.getRoi({ width: 25, height: 15 }), 25, 15, 12.5, 7.5, 0);
            return [2 /*return*/];
        });
    }); });
    it('whole image norm rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expectRotatedRectEq(image_utils_1.getRoi({ width: 4, height: 4 }, normRect), 4, 4, 2, 2, 0);
            expectRotatedRectEq(image_utils_1.getRoi({ width: 25, height: 15 }, normRect), 25, 15, 12.5, 7.5, 0);
            return [2 /*return*/];
        });
    }); });
    it('expanded norm rect.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expectRotatedRectEq(image_utils_1.getRoi({ width: 4, height: 4 }, normRect), 16, 8, 2, 4, 3);
            expectRotatedRectEq(image_utils_1.getRoi({ width: 25, height: 15 }, normRect), 100, 30, 12.5, 15, 3);
            return [2 /*return*/];
        });
    }); });
});
...
function expectPaddingClose(padding, top, bottom, left, right) {
    test_util_1.expectNumbersClose(padding.top, top, EPS);
    test_util_1.expectNumbersClose(padding.bottom, bottom, EPS);
    test_util_1.expectNumbersClose(padding.left, left, EPS);
    test_util_1.expectNumbersClose(padding.right, right, EPS);
}
describe('PadRoi', function () {
    it('no padding.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expectPaddingClose(image_utils_1.padRoi(roi, { width: 10, height: 10 }, false), 0, 0, 0, 0);
    ...
    it('horizontal padding.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            roi = { xCenter: 20, yCenter: 10, width: 100, height: 200, rotation: 5 };
            expectPaddingClose(image_utils_1.padRoi(roi, { width: 10, height: 10 }, true), 0, 0, 0.25, 0.25);
    ...
    it('vertical padding.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            expectPaddingClose(image_utils_1.padRoi(roi, { width: 10, height: 10 }, true), expectedHorizontalPadding, expectedHorizontalPadding, 0, 0);
