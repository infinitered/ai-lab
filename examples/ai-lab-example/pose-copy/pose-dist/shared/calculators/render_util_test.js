...
function getBinarySegmentation() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_util_2.loadImage('shared/three_people_binary_segmentation.png', WIDTH, HEIGHT)];
                case 1:
                    image = _a.sent();
                    return [4 /*yield*/, mask_util_1.toImageDataLossy(image)];
                case 2:
                    imageData = _a.sent();
...
function getColoredSegmentation() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_util_2.loadImage('shared/three_people_colored_segmentation.png', WIDTH, HEIGHT)];
                case 1:
                    image = _a.sent();
                    return [4 /*yield*/, mask_util_1.toImageDataLossy(image)];
                case 2:
...
function expectImage(actual, imageName) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            test_util_2.loadImage(imageName, WIDTH, HEIGHT)
                .then(function (image) { return mask_util_1.toImageDataLossy(image); })
                .then(function (expectedImage) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, test_util_1.expectArraysClose(actual.data, expectedImage.data)];
            }); }); });
            return [2 /*return*/];
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, test_util_2.loadImage('shared/three_people.jpg', WIDTH, HEIGHT)];
                case 1:
                    image = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('drawMask.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, mask_util_1.toImageDataLossy(canvas)];
                case 3:
                    imageMask = _a.sent();
