        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, test_util_2.loadImage('shared/image_to_tensor_input.jpg', 64, 128)];
                case 1:
                    input = _a.sent();
                    return [2 /*return*/];
            }
    ...
    function runTest(roi, config, expectedFileName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        imageTensor = convert_image_to_tensor_1.convertImageToTensor(input, config, roi).imageTensor;
                        _a = config.outputTensorFloatRange, rangeMin = _a[0], rangeMax = _a[1];
                        _b = image_utils_1.transformValueRange(rangeMin, rangeMax, 0, 255), scale = _b.scale, offset = _b.offset;
                        actualResult = tf.tidy(function () { return tf.add(tf.mul(imageTensor, scale), offset); });
                        tf.dispose(imageTensor);
                        return [4 /*yield*/, test_util_2.loadImage("shared/" + expectedFileName, config.outputTensorSize.width, config.outputTensorSize.height)
                    ...
                    case 1:
                        ...
                        test_util_1.expectArraysClose(new Uint8ClampedArray(actualResult.dataSync()), expectedResultRGB, EPS);
                        return [2 /*return*/];
                }
            });
        });
